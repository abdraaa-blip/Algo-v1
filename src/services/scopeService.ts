 ...
 */
export function filterTrendsByScope(trends: Trend[], scope: AppScope): Trend[] {
 ...
 */
export function getScopeHeroKey(
  scope: AppScope,
): "scope.hero.global" | "scope.hero.country" {
 ...
 */
export function getScopeHookKey(
  scope: AppScope,
): "scope.hook.global" | "scope.hook.country" {
