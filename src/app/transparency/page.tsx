...
const INTELLIGENCE_MODULES = [
  ...
  },
  {
    name: "Emotion Engine",
    description:
      "Détecte l'émotion dominante du contenu (curiosité, colère, humour, inspiration, peur).",
    icon: Brain,
  },
  {
    name: "Action Generator",
    description:
      "Suggère des actions concrètes pour capitaliser sur les tendances.",
    icon: CheckCircle,
  },
  {
    name: "Coherence Guard",
    description:
      "Valide les données et empêche l'affichage de contenus invalides.",
    icon: Shield,
  },
];
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/60 max-w-2xl mx-auto">
            ALGO s&apos;engage à être transparent sur la manière dont les
            données sont collectées, traitées et affichées. Cette page explique
            notre méthodologie.
          </p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                Les données affichées dans ALGO ne sont{" "}
                <strong>pas en temps réel</strong>. Elles sont mises à jour
                périodiquement selon les intervalles indiqués ci-dessous. Les
                indicateurs « ACTIF » signifient que les données ont été
                rafraîchies récemment, pas qu&apos;elles sont diffusées en
                direct.
              </p>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <p className="text-white/55 text-sm mb-4 leading-relaxed">
            Plusieurs écrans affichent un chiffre sur 100. Ils ne partagent pas
            forcément la même formule · voici la distinction utile pour éviter
            toute confusion. Détail formule « radar » public :{" "}
        ...
        <section id="algo-ai-directive" className="mb-12 scroll-mt-24">
          ...
          <p className="text-[var(--color-text-secondary)] text-sm mb-4 leading-relaxed max-w-3xl">
            Le modèle reçoit une directive interne sobre (clarté, pas de
            mysticisme, indicateurs sans promesse magique). Les huit familles
            ci-dessous ne sont pas des « codes secrets » : c’est une carte des
            rôles que le prompt vise à équilibrer · stratégie, sûreté, analyse,
            création, signaux sociaux, cohérence, production, persistance · pour
            rester aligné avec le reste du produit ALGO.
          </p>
          ...
          <p className="text-[var(--color-text-muted)] text-xs mt-4 leading-relaxed">
            ...
            <code className="text-[var(--color-text-tertiary)]">
              src/lib/ai/algo-directive-synthesis.ts
            </code>{" "}
            et{" "}
            <code className="text-[var(--color-text-tertiary)]">
              algo-persona.ts
                  ...
                  <div>
                    ...
                    <div className="flex gap-1 mt-1 flex-wrap">
                      {source.regions.map((r) => (
                        <span
                          key={r}
                          className="px-1.5 py-0.5 bg-[var(--color-card-hover)] border border-[var(--color-border)] rounded text-[10px] text-[var(--color-text-secondary)]"
                        >
                          {r}
                        </span>
                      ))}
        ...
        <section className="mb-12">
          ...
          <p className="text-white/60 mb-6 text-sm">
            Les agrégats de tendances s&apos;appuient surtout sur des règles,
            caches et scores dérivés des APIs. Certaines fonctions · analyseur
            viral, ALGO AI · peuvent appeler des modèles lorsque les clés sont
          ...
          <div className="bg-[var(--color-card)] border border-[var(--color-border)] rounded-xl p-5 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/50 text-sm">
                Données mises à jour dans les 15 dernières minutes
              </span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/50 text-sm">
                Données mises à jour dans la dernière heure
              </span>
            </div>
            <div className="flex items-center gap-3">
