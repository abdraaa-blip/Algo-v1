...
import { 
  Activity, TrendingUp, Share2, Search, MessageCircle, Clock,
  BarChart3, Zap, Brain, Target, Shield
} from 'lucide-react'
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 py-16 space-y-16">
        ...
        >
          ...
          <p className="text-lg text-white/50 max-w-2xl mx-auto">
            ...
            . Rien ici ne garantit une audience ou une viralité réelle : ce sont des indicateurs.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-sm text-white/40">
            ...
            <span className="w-1 h-1 rounded-full bg-white/20 hidden sm:block" />
            <Link href="/intelligence#algo-core" className="text-violet-400/90 hover:underline">
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-4">
            {algorithmDetails.signals.map((signal, index) => {
              const Icon = signalIcons[signal.name as keyof typeof signalIcons] || Activity
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-lg font-black text-violet-400">{signal.weight}</span>
                      </div>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { name: 'Signal Precoce', score: SCORE_THRESHOLDS.earlySignal, color: 'cyan', emoji: '🌱' },
              { name: 'Trending', score: SCORE_THRESHOLDS.trending, color: 'green', emoji: '📈' },
              { name: 'Viral', score: SCORE_THRESHOLDS.viral, color: 'orange', emoji: '🔥' },
              { name: 'Explosif', score: SCORE_THRESHOLDS.explosive, color: 'red', emoji: '💥' },
            ].map((tier, index) => (
              <motion.div
                key={tier.name}
            ...
            {[
              ...
              >
                <div className={cn(
                  ...
                  source.status === 'live' ? 'bg-green-400 animate-pulse' : 'bg-yellow-400'
                )} />
                <div>
