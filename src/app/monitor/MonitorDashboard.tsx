    ...
    <div className="min-h-screen bg-[#030014] text-white p-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--color-text-secondary)]">Vue système en temps réel</p>
            </div>
          </div>
          <div className="text-right">
            <div className="text-xs text-[var(--color-text-muted)]">Dernière mise à jour</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[var(--color-card)] rounded-2xl p-5 border border-[var(--color-border)] shadow-[var(--shadow-algo-sm)]">
          ...
          <div className="space-y-3">
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Disponibilité</span>
              <span className="font-mono">{formatUptime(metrics.orchestrator.uptime)}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Total des appels</span>
              <span className="font-mono">{metrics.orchestrator.totalFetches}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Taux de réussite</span>
              <span className={cn(
                'font-mono',
            ...
            <div className="mt-4 pt-4 border-t border-[var(--color-border)]">
              <div className="text-xs text-[var(--color-text-muted)] mb-2">Prochaine synchro</div>
        ...
        <div className="bg-[var(--color-card)] rounded-2xl p-5 border border-[var(--color-border)] shadow-[var(--shadow-algo-sm)]">
          ...
          <div className="space-y-3">
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Entrées totales</span>
              <span className="font-mono">{metrics.cache.totalEntries}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Efficacité cache</span>
              <span className={cn(
                'font-mono',
            ...
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Hits / ratés</span>
              <span className="font-mono">{metrics.cache.hits} / {metrics.cache.misses}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Hits périmés</span>
              <span className="font-mono text-yellow-400">{metrics.cache.staleHits}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Évictions</span>
              <span className="font-mono">{metrics.cache.evictions}</span>
            </div>
            
            {/* Entries per source */}
            <div className="mt-4 pt-4 border-t border-[var(--color-border)]">
              <div className="text-xs text-[var(--color-text-muted)] mb-2">Entrées par source</div>
              <div className="grid grid-cols-2 gap-2 text-xs">
        ...
        <div className="bg-[var(--color-card)] rounded-2xl p-5 border border-[var(--color-border)] shadow-[var(--shadow-algo-sm)]">
          ...
          <div className="space-y-3">
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Événements publiés</span>
              <span className="font-mono">{metrics.eventBus.eventsPublished}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Événements livrés</span>
              <span className="font-mono">{metrics.eventBus.eventsDelivered}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Abonnés</span>
              <span className="font-mono">{metrics.eventBus.subscriberCount}</span>
            </div>
            
            {/* Événements récents */}
            <div className="mt-4 pt-4 border-t border-[var(--color-border)]">
              <div className="text-xs text-[var(--color-text-muted)] mb-2">Événements récents</div>
        ...
        <div className="bg-[var(--color-card)] rounded-2xl p-5 border border-[var(--color-border)] shadow-[var(--shadow-algo-sm)]">
          ...
          <div className="space-y-3">
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Vérifications</span>
              <span className="font-mono">{metrics.coherence.checksPerformed}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Incohérences</span>
              <span className={cn(
                'font-mono',
            ...
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Corrections auto</span>
              <span className="font-mono">{metrics.coherence.autoFixes}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Auto-guérisons</span>
              <span className="font-mono">{metrics.coherence.selfHeals}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Composants suivis</span>
              <span className="font-mono">{metrics.coherence.trackedComponents}</span>
            </div>
            
            {/* Check Results */}
            <div className="mt-4 pt-4 border-t border-[var(--color-border)]">
              <div className="text-xs text-[var(--color-text-muted)] mb-2">État des vérifications</div>
        ...
        <div className="bg-[var(--color-card)] rounded-2xl p-5 border border-[var(--color-border)] shadow-[var(--shadow-algo-sm)]">
          ...
          <div className="space-y-3">
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Préchargements</span>
              <span className="font-mono">{metrics.performance.prefetchesPerformed}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Hits préchargement</span>
              <span className="font-mono">{metrics.performance.prefetchHits}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Efficacité préchargement</span>
              <span className={cn(
                'font-mono',
            ...
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Pauses de rafraîchissement</span>
              <span className="font-mono">{metrics.performance.adaptiveRefreshPauses}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--color-text-secondary)]">Motifs suivis</span>
            ...
            <div className="mt-4 pt-4 border-t border-[var(--color-border)]">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-[var(--color-text-secondary)]">Connexion</span>
        ...
        <div className="bg-[var(--color-card)] rounded-2xl p-5 border border-[var(--color-border)] shadow-[var(--shadow-algo-sm)]">
          ...
          <div className="mt-6 pt-4 border-t border-[var(--color-border)]">
            <div className="text-xs text-[var(--color-text-muted)] mb-2">Page actuelle</div>
        ...
        <div className="bg-[var(--color-card)] rounded-2xl p-5 border border-[var(--color-border)] shadow-[var(--shadow-algo-sm)]">
          ...
          {!autonomy ? (
            <p className="text-sm text-[var(--color-text-secondary)]">Lecture de la télémétrie d’autonomie…</p>
          ) : (
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between"><span className="text-[var(--color-text-secondary)]">Arrêt d’urgence</span><span className={autonomy.killSwitch ? 'text-rose-300 font-mono' : 'text-emerald-300 font-mono'}>{autonomy.killSwitch ? 'actif' : 'inactif'}</span></div>
              <div className="flex justify-between"><span className="text-[var(--color-text-secondary)]">Exécutions auto</span><span className="font-mono">{autonomy.counters.autoExecuted}</span></div>
              <div className="flex justify-between"><span className="text-[var(--color-text-secondary)]">Approbation requise</span><span className="font-mono">{autonomy.counters.approvalRequired}</span></div>
              <div className="flex justify-between"><span className="text-[var(--color-text-secondary)]">Approbations refusées</span><span className="font-mono">{autonomy.counters.approvalDenied}</span></div>
              <div className="flex justify-between"><span className="text-[var(--color-text-secondary)]">Simulations</span><span className="font-mono">{autonomy.counters.simRuns}</span></div>
            </div>
          )}
        </div>
        ...
        <div className="bg-[var(--color-card)] rounded-2xl p-5 border border-[var(--color-border)] shadow-[var(--shadow-algo-sm)]">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              <span className="text-[var(--color-text-secondary)]">Disjoncteurs</span>
              <span className="font-mono">{circuitSummary.total}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[var(--color-text-secondary)]">Circuits ouverts</span>
            ...
            <div className="pt-2 border-t border-[var(--color-border)] space-y-1">
              {opsAlerts.length === 0 ? (
                <p className="text-xs text-emerald-300">Aucune alerte ops active</p>
              ) : (
