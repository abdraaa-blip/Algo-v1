    ...
    <div className="min-h-screen text-[var(--color-text-primary)]">
      <div className="max-w-2xl mx-auto px-4 py-12 pb-24">
        ...
        <p className="text-sm text-white/55 mb-10">
          Informations relatives à l’édition du site <span className="text-white/75">{baseUrl}</span>. Les valeurs entre
          crochets disparaissent lorsque vous définissez les variables d’environnement indiquées.
        </p>
        ...
        <section className="space-y-3 text-sm text-white/70 leading-relaxed mb-10">
          ...
          <p>
            <strong className="text-white/85">Raison sociale / nom public :</strong> {operator}
          </p>
          <p>
        ...
        <section className="space-y-3 text-sm text-white/70 leading-relaxed mb-10">
          ...
          <p>
            La marque, l’interface et les contenus éditoriaux propres à ALGO sont protégés. Les données issues de tiers
            (APIs, flux) restent la propriété de leurs titulaires ; ALGO les agrège à des fins d’information et
            d’analyse.
          </p>
        </section>

        <section className="space-y-3 text-sm text-white/70 leading-relaxed mb-10">
          <h2 className="text-base font-semibold text-white">4. Limitation de responsabilité</h2>
          <p>
            Les scores, tendances et suggestions sont des <strong className="text-white/85">indicateurs</strong> à
            titre d’aide à la décision, sans garantie de résultat. L’utilisateur reste seul responsable de l’usage qu’il
            fait des informations affichées.
          </p>
        </section>
