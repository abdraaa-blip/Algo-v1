...
const USE_CASES = [
  {
    icon: Sparkles,
    audience: "Le créateur de contenu",
    benefit: "qui veut poster avant le pic de la tendance, pas après",
  },
  {
    icon: Users,
    audience: "L'influenceur",
    benefit: "qui veut savoir ce que son audience voudra demain, pas hier",
  },
  {
    icon: Eye,
    audience: "L'esprit curieux",
    benefit:
      "qui veut découvrir les meilleurs films, séries, musiques et vidéos maintenant, sans passer des heures à chercher",
  },
  {
    icon: Newspaper,
    audience: "Le journaliste",
    benefit: "qui repère une histoire avant qu'elle ne devienne une histoire",
  },
  {
    icon: Briefcase,
    audience: "L'agence",
    benefit: "qui apporte à ses clients non pas des opinions mais des signaux",
  },
  {
    icon: Mic,
    audience: "Le community manager",
    benefit: "qui veut repérer tôt ce qui compte pour son calendrier éditorial",
  },
  {
    icon: Lightbulb,
    audience: "L'entrepreneur",
    benefit:
      "qui repère les shifts culturels avant qu'ils ne deviennent des shifts de marché",
  },
  {
    icon: Film,
    audience: "Le cinéphile",
    benefit:
      "qui veut savoir quel film tout le monde va regarder la semaine prochaine",
  },
  {
    icon: Music,
    audience: "L'amateur de musique",
    benefit: "qui découvre le prochain hit avant qu'il n'explose",
  },
  {
    icon: Coffee,
    audience: "La personne qui veut simplement savoir",
    benefit:
      "ce qui se passe maintenant, pourquoi ça compte, et ce qui vient ensuite",
  },
];
...
const ALGO_TELLS_YOU = [
  {
    icon: TrendingUp,
    text: "Ce qui monte en visibilité maintenant et pourquoi (signaux agrégés, pas une vérité absolue)",
  },
  {
    icon: Clock,
    text: "Des sujets qui accélèrent · indicateurs sur les prochains jours, pas une prédiction garantie",
  },
  {
    icon: Film,
    text: "Quels films et séries créent du buzz dans les classements et flux que nous suivons",
  },
  {
    icon: Eye,
    text: "Quelles séries suscitent de l’engagement pour t’aider à choisir quoi regarder",
  },
  {
    icon: Music,
    text: "Quels sons et artistes ressortent dans les tendances musicales suivies",
  },
  {
    icon: Zap,
    text: "Quels formats et angles méritent un test, selon les signaux du moment (à valider par toi)",
  },
  {
    icon: Newspaper,
    text: "Quels sujets d’actu gagnent en volume · pour suivre l’information tôt, sans certitude médiatique",
  },
];
      ...
      <div className="relative z-10">
          ...
          >
            ...
            >
              <span
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #fff 0%, #a78bfa 50%, #7c3aed 100%)",
        ...
        <section className="px-6 py-32 max-w-4xl mx-auto">
          <AnimatedSection>
            <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-relaxed text-center">
              ALGO est pour tous ceux qui veulent etre{" "}
              <span className="text-violet-400">en avance</span>. Pas juste en
              avance sur l&apos;actu. En avance sur la{" "}
              <span className="text-pink-400">conversation</span>. En avance sur
              la <span className="text-cyan-400">culture</span>.
            </p>
          </AnimatedSection>
        </section>
        ...
        <section className="px-6 py-32 max-w-4xl mx-auto text-center">
          <AnimatedSection>
            <p className="text-xl md:text-2xl text-white/50 mb-8">
              Pas un reseau social. Pas un site d&apos;actu. Pas un moteur de
              recommandation.
            </p>
            <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-relaxed">
              Un <span className="text-violet-400">radar</span>. Un{" "}
              <span className="text-pink-400">decodeur</span>. Une{" "}
              <span className="text-cyan-400">avance sur le monde</span>.
            </p>
          </AnimatedSection>
        </section>
        ...
        <section className="px-6 py-24 max-w-4xl mx-auto">
          <AnimatedSection>
            <p className="text-xl md:text-2xl text-white/60 text-center leading-relaxed">
              Internet n&apos;a jamais ete aussi rapide. Le bruit n&apos;a
              jamais ete aussi fort.
              <span className="text-white font-bold">
                {" "}
                ALGO structure ces signaux pour t&apos;aider à décider plus tôt
              </span>
          ...
          <div className="max-w-4xl mx-auto">
            <AnimatedSection>
              ...
              <p className="text-center text-sm text-white/45 max-w-xl mx-auto mb-4">
                Tout est basé sur des sources publiques et des modèles internes
                : des estimations utiles, pas des promesses de résultat.
              </p>
        ...
        <section className="px-6 py-32 max-w-4xl mx-auto text-center">
          <AnimatedSection>
            ...
            <p
              className="text-3xl md:text-4xl lg:text-5xl font-black leading-tight mt-4"
              style={{ color: "#00FFB2" }}
            >
        ...
        <section className="px-6 py-16 max-w-xl mx-auto text-center">
          <AnimatedSection>
            ...
            <p className="text-[var(--color-text-secondary)] text-sm leading-relaxed">
              Même promesse que l&apos;appli : peu de bruit, des réponses
              utiles. L&apos;IA du produit est calibrée pour rester rationnelle,
              sans mysticisme · avec une carte de rôles publique sur la page
              transparence.
            </p>
            <Link
