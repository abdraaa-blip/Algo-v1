...
const FAILED_CONTENT: FailedContent[] = [
  {
    ...
    views: 1200,
    whyFailed:
      "Le challenge était trop compliqué à reproduire. Les gens n'ont pas compris les règles en 15 secondes.",
    lesson:
      "Un challenge viral doit être simple, reproductible instantanément, et montrer clairement ce qu'il faut faire.",
  },
  {
    id: "2",
    ...
    views: 3400,
    whyFailed:
      "Le trailer était déjà analysé par 50 autres créateurs. L'audience avait déjà vu les mêmes théories partout.",
    lesson:
      "Dans le format réaction, le timing est roi. Mieux vaut une vidéo rapide et imparfaite qu'une vidéo parfaite en retard.",
  },
  {
    id: "3",
    ...
    views: 890,
    whyFailed:
      "Le scandale était déjà dans la phase « conclusions » quand le post est sorti. Plus personne n'était intéressée.",
    lesson:
      "Les scandales ont une fenêtre de 24–48 h maximum. Après, il faut soit une nouvelle info exclusive, soit passer à autre chose.",
  },
  {
    id: "4",
    ...
    views: 450,
    whyFailed:
      "L'humour était trop niche et référencait des éléments que l'audience de la page ne connaissait pas.",
    lesson:
      "Connais ton audience. Un mème drôle pour toi peut être incompréhensible pour tes followers.",
  },
  {
    id: "5",
    ...
    views: 2100,
    whyFailed:
      "Pas de chapitres, pas de résumé au début, 20 minutes pour expliquer ce qui aurait pu tenir en 5.",
    lesson:
      "Structure ton contenu. Dis ce que tu vas montrer, montre-le, résume ce que tu as montré. Respecte le temps de l'audience.",
  },
];
      ...
      <section className="relative overflow-hidden border-b border-[var(--color-border)]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 pt-8 pb-6">
          ...
          <p className="text-sm max-w-lg text-[var(--color-text-secondary)]">
            Ces contenus avaient tout pour reussir, mais quelque chose a mal
            tourne. Apprends de leurs erreurs.
          </p>
        </div>
      </section>
