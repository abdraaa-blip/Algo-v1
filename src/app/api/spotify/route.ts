...
const COUNTRY_TO_MARKET: Record<string, string> = {
  'FR': 'FR', 'US': 'US', 'GB': 'GB', 'DE': 'DE', 'ES': 'ES',
  'IT': 'IT', 'BR': 'BR', 'JP': 'JP', 'KR': 'KR', 'AU': 'AU',
  'CA': 'CA', 'MX': 'MX', 'AR': 'AR', 'IN': 'IN', 'NL': 'NL'
}
...
async function fetchNewReleases(token: string, country: string): Promise<SpotifyTrack[]> {
  ...
  return data.albums?.items?.map((album: { id: string; name: string; artists: Array<{ name: string }>; images: Array<{ url: string }> }) => ({
    id: album.id,
    name: album.name,
...
const FALLBACK_TRACKS = [
  ...
  { id: '3', name: 'Birds of a Feather', artist: 'Billie Eilish', popularity: 94, viralScore: 88 },
  { id: '4', name: 'Espresso', artist: 'Sabrina Carpenter', popularity: 93, viralScore: 87 },
  { id: '5', name: 'Good Luck, Babe!', artist: 'Chappell Roan', popularity: 91, viralScore: 85 },
  { id: '6', name: 'A Bar Song (Tipsy)', artist: 'Shaboozey', popularity: 90, viralScore: 84 },
  { id: '7', name: 'Taste', artist: 'Sabrina Carpenter', popularity: 89, viralScore: 82 },
  { id: '8', name: 'I Can Do It With a Broken Heart', artist: 'Taylor Swift', popularity: 88, viralScore: 80 },
]
