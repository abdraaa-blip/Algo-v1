...
function transformTVShow(show: RealTVShow, index: number): Movie {
  ...
  return {
    ...
    genre: show.genres,
    description:
      show.overview || "Aucune description disponible pour cette serie.",
    cast: [],
    platforms: [{ name: "Streaming", url: "#", type: "streaming" }],
    trendingReason:
      index < 5 ? "Série la plus regardée" : "Tendance cette semaine",
...
function buildDemoMovies(): Movie[] {
  ...
  return [
    ...
    },
    {
      ...
      backdrop:
        "https://images.unsplash.com/photo-1440404653325-ab12749ade1d?w=1280&h=720&fit=crop",
      rating: 7.2,
      viralScore: 78,
      momentum: "stable",
    ...
    },
    {
      ...
      year: 2024,
      poster:
        "https://images.unsplash.com/photo-1574267432553-4b46cd3848df?w=500&h=750&fit=crop",
      backdrop:
        "https://images.unsplash.com/photo-1524712245354-2c4e34e713c7?w=1280&h=720&fit=crop",
      rating: 8.1,
      viralScore: 88,
      momentum: "exploding",
    ...
    },
    {
      ...
      year: 2022,
      poster:
        "https://images.unsplash.com/photo-1503095396549-807759245b35?w=500&h=750&fit=crop",
      backdrop:
        "https://images.unsplash.com/photo-1517602302552-471fe67acf66?w=1280&h=720&fit=crop",
      rating: 7.5,
      viralScore: 76,
      momentum: "rising",
...
export async function GET(request: NextRequest) {
  ...
  const rateLimit = checkRateLimit(`api-movies:${identifier}`, {
    limit: 60,
    windowMs: 60_000,
  });
  ...
  try {
    ...
    if (type === "movie" || type === "all") {
      ...
      if (
        trendingResult.source !== "live" ||
        nowPlayingResult.source !== "live"
      ) {
        source = "mixed";
      }
    }
