...
function generateContentIdeas(title: string, genres: string[], rating: number, type: 'movie' | 'series'): string[] {
  const ideas: string[] = []
...
export async function GET(
  ...
  try {
    ...
    if (type === 'tv') {
      ...
      if (tvDetails) {
        contentIdeas = generateContentIdeas(tvDetails.title, tvDetails.genres, tvDetails.rating, 'series')
        details = {
          ...tvDetails,
      ...
      if (movieDetails) {
        contentIdeas = generateContentIdeas(movieDetails.title, movieDetails.genres, movieDetails.rating, 'movie')
        details = {
          ...movieDetails,
          type: 'movie' as const,
          contentIdeas
