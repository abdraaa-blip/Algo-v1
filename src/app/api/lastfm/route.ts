...
const COUNTRY_NAMES: Record<string, string> = {
  ...
  DE: 'Germany', MA: 'Morocco', SN: 'Senegal', BE: 'Belgium',
  NG: 'Nigeria', CA: 'Canada', BR: 'Brazil', KR: 'South Korea',
}
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const contents = (tracks as LastFMTrack[]).slice(0, 10).map((track, i: number) => {
      ...
      return {
        ...
        insight: {
          ...
          bestFormat: 'montage',
          timingLabel: { fr: 'Son populaire maintenant', en: 'Popular sound now' },
