...
const FALLBACK_REPOS: TrendingRepo[] = [
  {
    ...
    owner: { name: "openai", avatar: "https://github.com/openai.png" },
  },
  {
    id: "vercel/ai",
    name: "ai",
    ...
    owner: { name: "vercel", avatar: "https://github.com/vercel.png" },
  },
  {
    ...
    owner: { name: "anthropics", avatar: "https://github.com/anthropics.png" },
  },
  {
  ...
  },
  {
    ...
    owner: { name: "microsoft", avatar: "https://github.com/microsoft.png" },
  },
];
...
function calculateViralScore(repo: TrendingRepo): number {
  ...
  const momentumScore = Math.min(
    20,
    (repo.starsToday / Math.max(repo.stars, 1)) * 1000,
  ); // Max 20 from momentum
