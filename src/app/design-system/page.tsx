...
export default function DesignSystemPage() {
  ...
  const insightLabels = {
    ...
    postWindow: {
      ...
      saturated: "Trend saturée",
      fading: "Signal s'éteint",
    },
    formatLabels: {
      face_cam: "Face cam",
      text: "Texte animé",
    ...
    <div className="max-w-4xl mx-auto px-4 py-10 space-y-14 min-h-dvh text-[var(--color-text-primary)]">
      ...
      <Section title="Button">
        <div className="flex flex-wrap gap-3">
          ...
          <Button variant="primary" icon={Zap} iconPosition="end">
            Icône fin
          </Button>
          ...
          {[
            {
              ...
              label: "growthRate=180, violet",
            },
            {
              growthRate: 30,
              color: "blue" as const,
              label: "growthRate=30, blue",
            },
            {
              growthRate: -15,
              color: "green" as const,
              label: "growthRate=-15, green",
            },
            ...
            >
              <LiveCurve growthRate={growthRate} color={color} opacity={0.2} />
      ...
      <Section title="SectionHeader">
        <div className="space-y-4 max-w-md">
          ...
          <SectionHeader
            title="Trends"
            subtitle="Ce qui monte, ce qui explose, ce qui s'installe"
