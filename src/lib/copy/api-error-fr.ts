...
const RATE_LIMIT_FR =
  "Trop de requêtes pour l'instant. Réessaie dans un moment.";
...
const EXACT: Record<string, string> = {
  ...
  "Failed to fetch rising stars":
    "Impossible de charger les rising stars. Réessaie.",
  ...
  "Failed to build intelligence snapshot":
    "Impossible de construire le snapshot intelligence. Réessaie.",
  ...
  "Entry not found in active memory window":
    "Entrée introuvable dans la fenêtre mémoire active.",
