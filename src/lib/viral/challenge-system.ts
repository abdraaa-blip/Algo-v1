...
export const DAILY_CHALLENGES: Omit<
  Challenge,
  "participantCount" | "completionRate"
>[] = [
  {
    id: "trend-hunter",
    type: "daily",
...
export const WEEKLY_CHALLENGES: Omit<
  Challenge,
  "participantCount" | "completionRate"
>[] = [
  {
...
// Limited Time Events
export const EVENT_CHALLENGES: Omit<
  Challenge,
  "participantCount" | "completionRate"
>[] = [
  {
...
export function calculateProgress(
  ...
  const totalCurrent = requirements.reduce(
    (sum, r) => sum + Math.min(r.current, r.target),
    0,
  );
