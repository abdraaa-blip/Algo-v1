...
export function createBuzzAlert(
  keyword: string,
  score: number,
  velocity: number,
): AlgoNotification {
...
export function createTrendExplosion(
  keyword: string,
  tier: string,
  platforms: string[],
): AlgoNotification {
...
export function createStarRisingAlert(
  starName: string,
  category: string,
  growth: number,
): AlgoNotification {
...
export function createPersonalizedAlert(
  keyword: string,
  reason: string,
): AlgoNotification {
  return {
...
export function createBreakingNewsAlert(
  headline: string,
  importance: number,
): AlgoNotification {
  return {
