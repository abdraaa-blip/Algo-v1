...
export function buildAskTransparencyLines(
...
export function expertiseTransparencyLineFr(level: AlgoExpertiseLevel): string {
  if (level === "novice")
    return "Niveau de réponse : débutant · vocabulaire guidé, moins de jargon.";
  if (level === "advanced")
    return "Niveau de réponse : expert · réponse plus dense et directe.";
