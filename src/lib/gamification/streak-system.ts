...
export const DAILY_REWARDS: DailyReward[] = [
  { day: 1, type: 'xp', value: 50, label: '+50 XP', icon: 'sparkles', claimed: false },
  { day: 2, type: 'xp', value: 75, label: '+75 XP', icon: 'zap', claimed: false },
  { day: 3, type: 'badge', value: 'early_bird', label: 'Badge Early Bird', icon: 'award', claimed: false },
  { day: 4, type: 'xp', value: 100, label: '+100 XP', icon: 'flame', claimed: false },
  { day: 5, type: 'feature', value: 'ai_insights', label: 'AI Insights 24h', icon: 'brain', claimed: false },
  { day: 6, type: 'xp', value: 150, label: '+150 XP', icon: 'rocket', claimed: false },
  { day: 7, type: 'mystery', value: 'mystery_box', label: 'Coffre Mystere', icon: 'gift', claimed: false },
]

export const ACHIEVEMENTS: Achievement[] = [
  // Streak achievements
  { id: 'streak_3', name: 'Debut Prometteur', description: '3 jours consecutifs', icon: 'flame', xpReward: 100, requirement: { type: 'streak', value: 3 }, rarity: 'common' },
  { id: 'streak_7', name: 'Semaine Parfaite', description: '7 jours consecutifs', icon: 'calendar', xpReward: 250, requirement: { type: 'streak', value: 7 }, rarity: 'rare' },
  { id: 'streak_30', name: 'Mois Legendaire', description: '30 jours consecutifs', icon: 'crown', xpReward: 1000, requirement: { type: 'streak', value: 30 }, rarity: 'epic' },
  { id: 'streak_100', name: 'Centurion', description: '100 jours consecutifs', icon: 'trophy', xpReward: 5000, requirement: { type: 'streak', value: 100 }, rarity: 'legendary' },
  
  // Visit achievements
  { id: 'visits_10', name: 'Habitue', description: '10 visites totales', icon: 'eye', xpReward: 50, requirement: { type: 'visits', value: 10 }, rarity: 'common' },
  { id: 'visits_50', name: 'Fidele', description: '50 visites totales', icon: 'heart', xpReward: 200, requirement: { type: 'visits', value: 50 }, rarity: 'rare' },
  { id: 'visits_500', name: 'Addicted', description: '500 visites totales', icon: 'zap', xpReward: 2000, requirement: { type: 'visits', value: 500 }, rarity: 'legendary' },
  
  // Referral achievements
  { id: 'referral_1', name: 'Ambassadeur', description: '1 parrainage', icon: 'users', xpReward: 200, requirement: { type: 'referrals', value: 1 }, rarity: 'common' },
  { id: 'referral_5', name: 'Influenceur', description: '5 parrainages', icon: 'megaphone', xpReward: 500, requirement: { type: 'referrals', value: 5 }, rarity: 'rare' },
  { id: 'referral_25', name: 'Viral Master', description: '25 parrainages', icon: 'star', xpReward: 2500, requirement: { type: 'referrals', value: 25 }, rarity: 'legendary' },
]
