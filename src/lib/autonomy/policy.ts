import type { ActionProposal, AutonomyMode, PolicyDecision } from '@/lib/autonomy/types'
import { recordApprovalDenied, recordApprovalRequired } from '@/lib/autonomy/telemetry'
...
export function evaluatePolicy(proposal: ActionProposal, options?: { dryRun?: boolean }): PolicyDecision {
