...
export function calculateViralScore(input: {
  ...
  const dataPoints = [growthRate, engagement, views].filter(
    (v) => v !== undefined && v > 0,
  ).length;
...
export function analyzeEmotion(text: string): EmotionAnalysis {
  ...
  const secondary =
    sortedEmotions[1]?.[1] > 0 ? sortedEmotions[1][0] : undefined;
...
const ACTION_TEMPLATES: Record<ContentType, ActionSuggestion[]> = {
  trend: [
    {
      id: "trend-1",
      action: "Créer une vidéo courte sur ce sujet",
      format: "Short/Reel",
      urgency: "immediate",
      difficulty: "easy",
    },
    {
      id: "trend-2",
      action: "Faire un thread explicatif",
      format: "Thread",
      urgency: "soon",
      difficulty: "medium",
    },
    {
      id: "trend-3",
      action: "Donner ton opinion en story",
      format: "Story",
      urgency: "immediate",
      difficulty: "easy",
    },
    {
      id: "trend-4",
      action: "Créer un carrousel informatif",
      format: "Carousel",
      urgency: "flexible",
      difficulty: "medium",
    },
  ...
  news: [
    {
      id: "news-1",
      action: "Reagir rapidement avec ton analyse",
      format: "Video/Post",
      urgency: "immediate",
      difficulty: "easy",
    },
    {
      id: "news-2",
      action: "Expliquer le contexte simplement",
      format: "Thread",
      urgency: "soon",
      difficulty: "medium",
    },
    {
      id: "news-3",
      action: "Créer une infographie résumée",
      format: "Image",
      urgency: "flexible",
      difficulty: "hard",
    },
  ...
  video: [
    {
      id: "video-1",
      action: "Faire un duet/stitch reaction",
      format: "Short/Reel",
      urgency: "immediate",
      difficulty: "easy",
    },
    {
      id: "video-2",
      action: "Analyser ce qui fonctionne",
      format: "Post",
      urgency: "flexible",
      difficulty: "medium",
    },
    {
      id: "video-3",
      action: "Adapter le format a ta niche",
      format: "Video",
      urgency: "soon",
      difficulty: "medium",
    },
  ...
  music: [
    {
      id: "music-1",
      action: "Utiliser ce son dans ta prochaine video",
      format: "Short/Reel",
      urgency: "immediate",
      difficulty: "easy",
    },
    {
      id: "music-2",
      action: "Créer un challenge avec ce son",
      format: "Challenge",
      urgency: "soon",
      difficulty: "medium",
    },
    {
      id: "music-3",
      action: "Faire un cover ou remix",
      format: "Video",
      urgency: "flexible",
      difficulty: "hard",
    },
  ...
  movie: [
    {
      id: "movie-1",
      action: "Partager ta critique rapide",
      format: "Story/Post",
      urgency: "soon",
      difficulty: "easy",
    },
    {
      id: "movie-2",
      action: "Créer un top 5 thématique",
    ...
    {
      id: "movie-3",
      action: "Analyser une scene marquante",
      format: "Video",
      urgency: "flexible",
      difficulty: "hard",
    },
...
export function generateActions(
  ...
  if (emotion.primary !== "neutral" && emotion.intensity > 0.5) {
    const emotionActions: Record<EmotionType, ActionSuggestion> = {
      curiosity: {
        id: "emo-1",
        action: "Reveler les details caches",
        format: "Video",
        urgency: "immediate",
        difficulty: "medium",
      },
      anger: {
        id: "emo-2",
        action: "Donner ton avis authentique",
        format: "Video/Post",
        urgency: "immediate",
        difficulty: "easy",
      },
      humor: {
        id: "emo-3",
        action: "Surfer sur l'humour avec un meme",
        format: "Image/Short",
        urgency: "immediate",
        difficulty: "easy",
      },
      inspiration: {
        id: "emo-4",
        action: "Partager ta propre histoire",
        format: "Story/Post",
        urgency: "soon",
        difficulty: "medium",
      },
      ...
      neutral: {
        id: "emo-6",
        action: "Informer de maniere factuelle",
        format: "Post",
        urgency: "flexible",
        difficulty: "easy",
      },
...
export function validateContent(
  content: Partial<RawContentInput>,
): ValidationResult {
  const errors: string[] = [];
  ...
  if (content.growthRate === undefined)
    warnings.push("Taux de croissance non disponible");
...
export function createFallback(
  partial: Partial<RawContentInput>,
): RawContentInput {
  return {
...
export function processContent(input: RawContentInput): ContentIntelligence {
  ...
  // Overall confidence
  const confidence =
    (viralScore.confidence + (emotion.intensity > 0 ? 0.8 : 0.5)) / 2;
 ...
 */
export function processContentBatch(
