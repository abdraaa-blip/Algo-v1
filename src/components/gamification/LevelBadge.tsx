...
const LEVEL_COLORS: Record<number, { primary: string; secondary: string; glow: string }> = {
  1: { primary: '#6B7280', secondary: '#374151', glow: 'rgba(107,114,128,0.3)' },
...
export function LevelBadge({ 
  ...
  const sizes = {
    ...
    md: { badge: 'w-12 h-12', icon: 'w-6 h-6', text: 'text-sm', progress: 'h-1.5' },
    lg: { badge: 'w-16 h-16', icon: 'w-8 h-8', text: 'text-base', progress: 'h-2' }
  }
      ...
      <div className="flex-1 min-w-0">
        ...
        {showProgress && (
          <div className="mt-1.5">
            ...
            <div className={`${s.progress} rounded-full bg-white/10 overflow-hidden`}>
              <motion.div
                initial={{ width: 0 }}
