...
import { getLocalStreak, generateReferralCode } from '@/lib/gamification/streak-system'
  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(123,97,255,0.15) 0%, rgba(0,255,178,0.1) 100%)',
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              style={{ 
                background: copied ? 'rgba(0,255,178,0.2)' : 'rgba(123,97,255,0.2)',
          ...
          <div>
            ...
            <div className="h-2 rounded-full bg-white/10 overflow-hidden">
              <motion.div
                ...
                style={{ background: 'linear-gradient(90deg, #7B61FF, #00FFB2)' }}
              />
            </div>
          </div>
        )}
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <h4 className="text-sm font-bold text-white">Paliers de recompenses</h4>
        </div>
            ...
            >
              <div 
                className={`w-8 h-8 rounded-lg flex items-center justify-center font-bold text-sm ${
                  reward.unlocked ? 'bg-violet-500 text-white' : 'bg-white/10 text-white/40'
                }`}
              >
                {reward.count}
              </div>
              <div className="flex-1">
                <p className={`text-sm font-medium ${reward.unlocked ? 'text-white' : 'text-white/50'}`}>
                  {reward.reward}
                </p>
