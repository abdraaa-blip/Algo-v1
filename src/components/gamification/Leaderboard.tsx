...
export function Leaderboard({
  ...
  const getRankBg = (rank: number) => {
    switch (rank) {
      case 1:
        return "bg-gradient-to-r from-amber-900/30 to-amber-800/10 border-amber-500/30";
      case 2:
        return "bg-gradient-to-r from-zinc-800/50 to-zinc-700/20 border-zinc-500/30";
      case 3:
        return "bg-gradient-to-r from-amber-950/30 to-amber-900/10 border-amber-700/30";
      default:
        ...
        <div className="space-y-2">
          {entries.slice(0, 5).map((entry, index) => (
            ...
            >
              ...
              {entry.change !== 0 && (
                <div
                  className={`flex items-center gap-0.5 text-xs ${entry.change > 0 ? "text-emerald-400" : "text-rose-400"}`}
                >
                  <TrendingUp
