  ...
  return (
    <>
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(255,107,0,0.15) 0%, rgba(255,77,109,0.1) 100%)",
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #FF6B00 0%, #FF4D6D 100%)",
                }}
              >
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-lg font-bold text-white">
                  {streak.currentStreak} jour
                  {streak.currentStreak > 1 ? "s" : ""} de suite
                </span>
              ...
              <p className="text-sm text-white/50">
                Record: {streak.longestStreak} jours | {streak.totalVisits}{" "}
                visites
              </p>
            </div>
          </div>
          ...
          <div className="text-right">
            ...
            <div className="mt-1 w-32 h-2 rounded-full bg-white/10 overflow-hidden">
              <motion.div
                ...
                style={{
                  background: "linear-gradient(90deg, #7B61FF, #9F7AEA)",
                }}
              />
            </div>
            ...
            >
              ...
              >
                <p className="text-sm text-white/50 mb-2">
                  Recompense du jour {((streak.currentStreak - 1) % 7) + 1}/7
                </p>
              ...
              <motion.button
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #7B61FF 0%, #9F7AEA 100%)",
                }}
              >
                Continuer
