  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div
            className={`relative overflow-hidden rounded-2xl border-2 ${colors.border} ${colors.bg} backdrop-blur-xl p-4 shadow-2xl min-w-[320px]`}
          >
            {/* Sparkle effects */}
...
export function AchievementToastManager() {
  ...
  return (
    <AchievementUnlock achievement={current} onClose={() => setCurrent(null)} />
  );
}
