...
export function LiveIndicator({ className }: { className?: string }) {
  return (
    <div className={cn('flex items-center gap-1.5', className)}>
      ...
      <span className="text-[10px] font-medium text-amber-400">MAJ recente</span>
    </div>
  )
}
...
export function DataFlowVisualizer({ className, particleCount = 20 }: DataFlowVisualizerProps) {
