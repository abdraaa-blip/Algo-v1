...
export function ShortcutsModal() {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("algo:show-shortcuts", handleShowShortcuts);
  }, []);
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-[var(--color-border)]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-[var(--color-text-primary)] font-bold">
                Raccourcis clavier
              </h2>
        ...
        <div className="p-4 border-t border-[var(--color-border)] text-center">
          <p className="text-xs text-[var(--color-text-muted)]">
            Appuyez sur{" "}
            <kbd className="px-1.5 py-0.5 rounded bg-[var(--color-card)] border border-[var(--color-border)] font-mono">
              Esc
            </kbd>{" "}
            pour fermer
          </p>
