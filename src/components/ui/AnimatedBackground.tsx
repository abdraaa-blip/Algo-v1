...
export function AnimatedBackground({
  ...
  const particleCount = useMemo(() => {
    ...
    return Math.max(
      20,
      Math.min(150, Math.floor(baseCount * (intensity / 50))),
    );
  ...
  return (
    <div className={cn("fixed inset-0 pointer-events-none", className)}>
      ...
      {showGlow && (
        <>
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(123, 97, 255, 0.3) 0%, transparent 70%)",
              top: "10%",
              left: "15%",
      ...
      <div
        ...
        style={{
          background:
            "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(123, 97, 255, 0.1) 2px, rgba(123, 97, 255, 0.1) 4px)",
        }}
      />
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(123, 97, 255, 0.08) 0%, transparent 60%)",
          top: "-200px",
          left: "-200px",
          filter: "blur(80px)",
        }}
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(0, 209, 255, 0.06) 0%, transparent 60%)",
          bottom: "-100px",
          right: "-100px",
          filter: "blur(100px)",
        }}
