...
const cfg: Record<GrowthTrend, { icon: typeof TrendingUp; cls: string }> = {
  up: {
    icon: TrendingUp,
    cls: "bg-[rgba(0,255,178,0.12)]  border-[rgba(0,255,178,0.22)]  text-emerald-400",
  },
  stable: {
    icon: Minus,
    cls: "bg-[rgba(0,209,255,0.12)]  border-[rgba(0,209,255,0.22)]  text-sky-400",
  },
  down: {
    icon: TrendingDown,
    cls: "bg-white/5                  border-white/10                 text-white/35",
  },
};

const levelCfg: Record<
  MomentumLevel | "rising" | "steady" | "fading",
  { icon: typeof TrendingUp; cls: string; label: string }
> = {
  high: {
    icon: Flame,
    cls: "bg-orange-500/15 border-orange-500/25 text-orange-400",
    label: "Fort",
  },
  medium: {
    icon: Zap,
    cls: "bg-violet-500/12 border-violet-500/22 text-violet-400",
    label: "Moyen",
  },
  low: {
    icon: Minus,
  ...
  rising: {
    icon: TrendingUp,
    cls: "bg-emerald-500/12 border-emerald-500/22 text-emerald-400",
    label: "Monte",
  },
  peaked: {
    icon: Zap,
  ...
  steady: {
    icon: Minus,
    cls: "bg-[#00D1FF]/10 border-[#00D1FF]/20 text-[#00D1FF]",
    label: "Stable",
  },
  cooling: {
    icon: TrendingDown,
  ...
  fading: {
    icon: TrendingDown,
    cls: "bg-white/3 border-white/8 text-white/30",
    label: "Declin",
  },
};
