...
export function CommandPalette() {
  ...
  const allCommands = useMemo<CommandItem[]>(() => [
    ...
    { id: 'nav-news', title: 'Actualites', subtitle: 'Les dernieres infos', icon: <Newspaper size={18} />, action: () => navigate('/news'), category: 'navigation', keywords: ['news', 'actualites'] },
    ...
    { id: 'nav-transparency', title: 'Transparence', subtitle: 'Données, scores & calibrage IA', icon: <Scale size={18} />, action: () => navigate(SITE_TRANSPARENCY_AI_CALIBRATION_HREF), category: 'navigation', keywords: ['transparence', 'donnees', 'sources', 'calibrage', 'scores'] },
