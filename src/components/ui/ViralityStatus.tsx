  ...
  if (variant === "pill") {
    return (
      ...
      >
        <Icon
          size={12}
          className={level === "exploding" ? "animate-pulse" : ""}
        />
        {showLabel && config.labelFr}
...
export function ViralIndicator({
  ...
  return (
    <div className={cn("flex items-center gap-1", className)}>
      <Icon
        size={12}
        className={cn(config.color, level === "exploding" && "animate-pulse")}
      />
