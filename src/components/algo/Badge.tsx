...
const BADGE_CONFIG: Record<BadgeType, { bg: string; tx: string; dot: string | null; labelFr: string }> = {
  Viral: { bg: 'rgba(123,97,255,0.22)', tx: '#c4b5fd', dot: '#7B61FF', labelFr: 'Viral' },
  Early: { bg: 'rgba(0,255,178,0.16)', tx: '#6ee7b7', dot: '#00FFB2', labelFr: 'Signal' },
  Breaking: { bg: 'rgba(255,77,109,0.22)', tx: '#fca5a5', dot: '#FF4D6D', labelFr: 'Urgent' },
  Trend: { bg: 'rgba(0,209,255,0.16)', tx: '#7dd3fc', dot: '#00D1FF', labelFr: 'Tendance' },
  AlmostViral: { bg: 'rgba(255,255,255,0.08)', tx: 'rgba(240,240,248,0.38)', dot: null, labelFr: 'Montant' },
}
