...
export function TrendActionCard({
  trend,
  onCreateClick,
  onDetailsClick,
}: TrendActionCardProps) {
  ...
  const handleCreate = () => {
    if (onCreateClick) {
      ...
      router.push(
        `/creator-mode?trend=${encodeURIComponent(trend.name)}&platform=${encodeURIComponent(trend.platform)}&format=${encodeURIComponent(trend.format)}`,
      );
    }
  };
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(123,97,255,0.1), rgba(0,255,178,0.05))",
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(123,97,255,0.15), rgba(123,97,255,0.05))",
            ...
            {trend.views && trend.views > 0 && (
              <div className="flex flex-col">
                ...
                <span className="text-xs text-white/80 font-medium">
                  {trend.views >= 1000000
                    ? `${(trend.views / 1000000).toFixed(1)}M`
                    : trend.views >= 1000
                      ? `${(trend.views / 1000).toFixed(0)}K`
                      : trend.views}{" "}
                  vues
                </span>
              </div>
            ...
            {trend.growthRate && (
              <div className="flex flex-col">
                ...
                <span
                  className="text-xs font-medium"
                  style={{
                    color: trend.growthRate > 100 ? "#00FFB2" : "#FFC107",
                  }}
                >
                  +{trend.growthRate}%
                </span>
        ...
        <div className="px-4 pb-2">
          ...
          >
            <span className="text-white/40">
              Origine: <span className="text-white/60">{trend.origin}</span>
            </span>
            <TrendingUp size={10} className="text-emerald-400" />
            <span className="text-emerald-400">
              Arrive sur {trend.arrivesOn}
            </span>
          </div>
        </div>
      )}
...
export function TrendActionCardCompact({
  trend,
  onClick,
}: {
  trend: TrendData;
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 text-[10px] text-white/40">
            <span>
              {emotionIcons[trend.emotion] || "🎭"} {trend.emotion}
            </span>
            <span>•</span>
            <span>
            ...
            <span>•</span>
            <span
              className={trend.status === "hot" ? "text-red-400 font-bold" : ""}
            >
