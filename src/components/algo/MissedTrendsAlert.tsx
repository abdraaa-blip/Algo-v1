...
export function MissedTrendsAlert({ className }: MissedTrendsAlertProps) {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(255,77,109,0.12) 0%, rgba(255,77,109,0.05) 100%)",
    ...
    >
      ...
      <div className="p-3 sm:p-4 flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-xs sm:text-sm font-semibold text-white/90 mb-1">
            Tu as rate{" "}
            <span className="text-[#FF4D6D]">{missedCount} tendances</span> hier
          </p>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, #FF4D6D 0%, rgba(255,77,109,0.3) 100%)",
        }}
      />
    </div>
  );
