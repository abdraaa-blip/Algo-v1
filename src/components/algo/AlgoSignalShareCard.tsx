      ...
      <div className="rounded-xl border border-[var(--color-border)] overflow-x-auto bg-[var(--color-bg-primary)] max-w-full">
        ...
        >
          <div className="flex items-center justify-between gap-2">
            <span className="text-lg font-black tracking-tight text-white">ALGO</span>
            <span className="text-[10px] font-bold uppercase tracking-widest text-cyan-400/90">Signal</span>
          </div>
          {badgeLabel ? (
          ...
          <p className="text-base font-bold text-white/95 leading-snug line-clamp-3">{headline}</p>
          <div className="flex items-end justify-between gap-2 mt-auto pt-2 border-t border-[var(--color-border)]">
            <div>
              <p className="text-[9px] uppercase tracking-wider text-[var(--color-text-tertiary)] font-semibold">Score radar</p>
