  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      >
        ...
        <line x1="0" y1="150" x2="1440" y2="150" stroke="rgba(255,255,255,0.02)" strokeWidth="1" />
        <line x1="0" y1="300" x2="1440" y2="300" stroke="rgba(255,255,255,0.02)" strokeWidth="1" />
        <line x1="0" y1="450" x2="1440" y2="450" stroke="rgba(255,255,255,0.02)" strokeWidth="1" />
        <line x1="0" y1="600" x2="1440" y2="600" stroke="rgba(255,255,255,0.02)" strokeWidth="1" />
        <line x1="0" y1="750" x2="1440" y2="750" stroke="rgba(255,255,255,0.02)" strokeWidth="1" />
        <line x1="240" y1="0" x2="240" y2="900" stroke="rgba(255,255,255,0.02)" strokeWidth="1" />
        <line x1="480" y1="0" x2="480" y2="900" stroke="rgba(255,255,255,0.02)" strokeWidth="1" />
        <line x1="720" y1="0" x2="720" y2="900" stroke="rgba(255,255,255,0.02)" strokeWidth="1" />
        <line x1="960" y1="0" x2="960" y2="900" stroke="rgba(255,255,255,0.02)" strokeWidth="1" />
        <line x1="1200" y1="0" x2="1200" y2="900" stroke="rgba(255,255,255,0.02)" strokeWidth="1" />
      </svg>
    </div>
  )
}
