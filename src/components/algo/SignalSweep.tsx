  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, transparent 0%, #7B61FF 50%, transparent 100%)",
          boxShadow:
            "0 0 30px 10px rgba(123, 97, 255, 0.5), 0 0 60px 20px rgba(123, 97, 255, 0.3)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgba(123, 97, 255, 0.2) 0%, transparent 100%)",
          animationDelay: "0.1s",
        }}
      />
    </div>
