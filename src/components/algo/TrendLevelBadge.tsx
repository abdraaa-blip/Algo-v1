...
const LEVEL_CONFIG: Record<TrendLevel, {
  icon: typeof Flame
  label: string
  labelFr: string
  bg: string
...
const SIZE_CONFIG = {
  sm: { padding: 'px-1.5 py-0.5', text: 'text-[8px]', icon: 10, gap: 'gap-0.5' },
...
export function getTrendLevel(viralScore: number, growthRate?: number): TrendLevel {
