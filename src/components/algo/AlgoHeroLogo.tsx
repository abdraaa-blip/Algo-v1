...
const TAGLINES = [
  ...
  },
  {
    ...
    highlights: [{ text: "tôt sur la courbe", color: "text-cyan-400" }],
    connector: " ",
    ending: ".",
  },
  {
  ...
  {
    text: "Ton avantage",
    highlights: [{ text: "compétitif", color: "text-emerald-400" }],
    connector: " ",
    ending: " sur les autres créateurs.",
  },
  {
    text: "Transforme les",
    highlights: [{ text: "signaux faibles", color: "text-violet-400" }],
    connector: " ",
    ending: " en contenus viraux.",
  },
  {
    text: "L'algorithme qui",
    highlights: [{ text: "decode", color: "text-cyan-400" }],
    connector: " ",
    ending: " tous les autres.",
  },
  {
    text: "Prévois ce qui va",
    highlights: [{ text: "exploser", color: "text-orange-400" }],
    connector: " ",
    ending: " demain.",
  },
  {
    text: "Fini de",
    highlights: [{ text: "deviner", color: "text-red-400" }],
    connector: " ",
    ending: ". Commence à savoir.",
  },
  {
    text: "Un meta-radar",
    highlights: [{ text: "au-dessus", color: "text-violet-400" }],
    connector: " ",
    ending: " des feeds · pas une copie, une couche au-dessus.",
  },
  {
    text: "Lis",
    highlights: [{ text: "plusieurs plateformes", color: "text-cyan-400" }],
    connector: " ",
...
export function AlgoHeroLogo({
  ...
  if (!mounted) {
    ...
    return (
      ...
      >
        ...
        {variant === "full" ? (
          <div className="h-4 w-56 rounded mt-4 opacity-0" />
        ) : null}
      </div>
    );
  }
  ...
  if (variant === "mark") {
    return (
      <div
        className="flex flex-col items-center text-center select-none px-4 mt-2"
        aria-hidden
      >
        <p
      ...
      >
        ...
        {currentTagline.highlights.map((highlight, i) => (
          <span key={i}>
            ...
            {i < currentTagline.highlights.length - 1 &&
              currentTagline.connector}
          </span>
        ))}
