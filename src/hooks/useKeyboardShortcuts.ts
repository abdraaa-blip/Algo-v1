...
export function useKeyboardShortcuts(customShortcuts: KeyboardShortcut[] = []) {
  ...
  const builtInShortcuts: KeyboardShortcut[] = useMemo(
    () => [
      ...
      { key: 't', description: 'Go to Trends', action: () => router.push('/trends') },
      { key: 'v', description: 'Go to Videos', action: () => router.push('/videos') },
      { key: 'n', description: 'Go to News', action: () => router.push('/news') },
      { key: 'c', description: 'Go to Creator Mode', action: () => router.push('/creator-mode') },
      { key: 's', description: 'Go to Rising Stars', action: () => router.push('/rising-stars') },
      {
        key: '/',
