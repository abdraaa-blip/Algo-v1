...
export function useContentTransformer() {
  const transformTrend = useCallback(
    (trend: {
      id?: string;
      name?: string;
      title?: string;
      ...
      return {
        ...
        views:
          typeof trend.views === "string" ? parseInt(trend.views) : trend.views,
  ...
  const transformNews = useCallback(
    (news: {
      id?: string;
      title?: string;
      description?: string;
  ...
  const transformMusic = useCallback(
    (track: {
      id?: string;
      name?: string;
      title?: string;
...
export type { RawContentInput, ContentIntelligence, ContentType };
