...
import type { AlgoObsLayer, AlgoObsLog, AlgoObsSeverity } from '@/core/observability/types'
...
export function getCriticalErrors(): AlgoObsLog[] {
  return buffer.filter((l) => l.type === 'critical').sort((a, b) => b.timestamp - a.timestamp)
}
